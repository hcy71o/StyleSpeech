...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='/home/hcy71/DATA/preprocessed_data/LibriTTS')
    parser.add_argument('--output_path', type=str, default='/home/hcy71/DATA/preprocessed_data/LibriTTS')
